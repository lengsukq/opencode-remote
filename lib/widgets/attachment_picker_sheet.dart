    ...
    child: SafeArea(
      child: Column(
        ...
        children: [
          ...
          _attachmentOption(context, Icons.image, S.image, 'From Gallery', 'image'),
          _attachmentOption(context, Icons.camera_alt, S.camera, 'Take a Photo', 'camera'),
          _attachmentOption(context, Icons.attach_file, S.file, 'From Local Storage', 'file'),
